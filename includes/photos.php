...
if($u == $log_username && $user_ok == true){
	...
	$photo_form .=     '<option value="Persoonlijk">Myself</option>';
	$photo_form .=     '<option value="Familie">Family</option>';
	$photo_form .=     '<option value="Huisdieren">Pets</option>';
	$photo_form .=     '<option value="Vrienden">Friends</option>';
...
function deletePhoto(id){
	var conf = confirm("OK om foto te verwijderen.");
	if(conf != true){
		return false;
	}
